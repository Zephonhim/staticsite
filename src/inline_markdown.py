...
def text_to_textnodes(text):
    ...
    boldnodes = split_nodes_delimiter(nodes, "**", TextType.BOLD)
    italicnodes = split_nodes_delimiter(boldnodes, "_", TextType.ITALIC)
    codenodes = split_nodes_delimiter(italicnodes, "`", TextType.CODE)
